...
| [Pi gateway image (Release)](https://github.com/dadonec-boop/MK3-FR3D-Addon/releases/tag/pi-gateway-v0.4) | Optional Raspberry Pi Zero 2 W factory image (binary only, see Releases) |
...
- **[fr3daddon-v0.4-small.img.zst](https://github.com/dadonec-boop/MK3-FR3D-Addon/releases/download/pi-gateway-v0.4/fr3daddon-v0.4-small.img.zst)**  
  Release notes: [pi-gateway-v0.4](https://github.com/dadonec-boop/MK3-FR3D-Addon/releases/tag/pi-gateway-v0.4)

### Flash with Raspberry Pi Imager

1. Download [Raspberry Pi Imager](https://www.raspberrypi.com/software/).
2. Insert a micro SD card (**32 GB** or larger recommended).
3. Open Imager → **Choose OS** → **Use custom** → select `fr3daddon-v0.4-small.img.zst`.
...
- Pi gateway image: [fr3daddon-v0.4-small.img.zst](https://github.com/dadonec-boop/MK3-FR3D-Addon/releases/download/pi-gateway-v0.4/fr3daddon-v0.4-small.img.zst)
