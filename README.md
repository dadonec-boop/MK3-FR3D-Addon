...
- **[fr3daddon-v0.5-small.img.zst](https://github.com/dadonec-boop/MK3-FR3D-Addon/releases/download/pi-gateway-v0.5/fr3daddon-v0.5-small.img.zst)**  
...
3. Open Imager → **Choose OS** → **Use custom** → select `fr3daddon-v0.5-small.img.zst`.
...
- Pi gateway image: [fr3daddon-v0.5-small.img.zst](https://github.com/dadonec-boop/MK3-FR3D-Addon/releases/download/pi-gateway-v0.5/fr3daddon-v0.5-small.img.zst)
