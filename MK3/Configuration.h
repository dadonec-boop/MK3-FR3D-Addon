...
#define EXTRUDE_MINTEMP 148  //min temp that extruder motor will run
//this prevents dangerous Extruder moves, i.e. if the temperature is under the limit
//can be software-disabled for whatever purposes by
#define PREVENT_DANGEROUS_EXTRUDE


#define DEFAULT_ESTEP_PER_REV 489.6  //default setting for the extruder step calibration  1:15.3 gear. 61.6=1/2, 122.8=1/4, 244.8=1/6, 489.6=1/8
#define DEFAULT_PSTEP_PER_MM 10.61  //default setting for the puller motor step calibration  without gear
...
#define DEFAULT_MOTOR_ACCELERATION  300   // E and P max acceleration in mm/s^2 - controls extruder acceleration
