...
//#ifdef PIDTEMPBED
  ...
  float fr3d_pred_p_star = 0.0f;
  uint8_t fr3d_pred_p_star_valid = 0;
  ...
  float fr3d_pred_hold_m = FR3D_PRED_HOLD_M_DEFAULT;
  uint16_t fr3d_pred_hold_timeout_s = (uint16_t)FR3D_PRED_HOLD_TIMEOUT_S_DEFAULT;
