...
#define KILL_PIN           -1
  ...
  #define HEATER_0_PIN     -1    // RAMPS 1.1
...
#define HEATER_0_PIN       -1	//12V PWM1
...
//x axis pins
    ...
    #define HEATER_0_PIN    -1    //changed @ rkoeppl 20110410
    #define HEATER_1_PIN    -1
    #define HEATER_2_PIN    -1
    #if MOTHERBOARD == 5
...
#define HEATER_0_PIN        -1 /*DONE PWM on RIGHT connector */
#define HEATER_1_PIN       -1
#define HEATER_2_PIN       -1
#define HEATER_1_PIN       -1
#define HEATER_2_PIN       -1
